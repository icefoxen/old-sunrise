...
and structitem =
  (* Name type, default value, is inlined? *)
  Structitem of string * typestm * stmt * bool
...
and typestm =
  ...
  | Customtype of string
      (* A void type.  Used ONLY when a function returns nothing meaningful *)
  | Voidtype
